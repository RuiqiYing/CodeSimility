...
#     # with open('./files/1.txt', 'r') as x, open('./files/2.txt', 'r') as y:
#     # with open('./files/tiankong1.txt', 'r',encoding='UTF-8') as x, open('./files/tiankong2.txt', 'r',encoding='UTF-8') as y:
#     with open('./files/wenzi1.txt', 'r',encoding='UTF-8') as x, open('./files/wenzi2.txt', 'r',encoding='UTF-8') as y:
#         content_x = x.read()
#         content_y = y.read()
